...
<body>
    <nav class="navbar navbar-expand-md navbar-light" style="background-color: #eceefa ;">
        <div class="container d-flex align-items-center justify-content-between">
            
            <div class="d-flex align-items-center">
                <img src="{{ asset('Logo.png') }}" alt="IDA IMMO" class="rounded-circle" style="width: 120px; height: 120px; object-fit: cover;">
                <h5 style="color: #4e4e52 ;"> <br>Agence Immobilière IDA IMMO</h5>
            </div>
