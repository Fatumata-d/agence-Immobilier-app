...
<div class="container py-5">
    <div class="card shadow-lg rounded-4 mx-auto" style="max-width: 800px;">
        <div class="card-body px-4 py-5">
            <h1 class="text-center text-principal fw-bold mb-4">Nos Coordonnées</h1>

            <div class="mb-4">
                <h5 class="text-uppercase fw-bold text-principal">Téléphone</h5>
                <p class="text-muted fs-5 mb-2">+221 77 123 45 67</p>
            </div>

            <div class="mb-4">
                <h5 class="text-uppercase fw-bold text-principal">Email</h5>
                <p class="text-muted fs-5 mb-2">contact@immobilier-sn.com</p>
            </div>

            <div class="mb-4">
                <h5 class="text-uppercase fw-bold text-principal">Adresse</h5>
            ...
            <div class="mb-4">
                <h5 class="text-uppercase fw-bold text-principal">Localisation</h5>
