...
@section('content')
    ...
    @foreach ($biens as $bien)
        ...
        @if(session('client'))
        <a href="{{ route('reservation.formulaire', $bien->id) }}" style="margin-top: 10px; display: inline-block; padding: 8px 15px; background-color: green; color: white; text-decoration: none;">
            Réserver ce bien
        </a>
    @endif
    @endforeach
