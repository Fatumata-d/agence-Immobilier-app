    ...
    <div class="container">
        <div class="row align-items-center g-4">
            <div class="col-lg-6">
                ...
                <a href="{{ route('Biens') }}" class="btn btn-primary style="background-color: #eceefa ;"" style="background-color: #121946ff ;">Voir les biens disponibles</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div id="testimonialCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1000">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body text-center p-4">
                                    <img src="{{ asset('cheikh.jpg') }}" class="rounded-circle mb-3" width="180" alt="Client">
                        ...
                        <div class="carousel-item">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body text-center p-4">
                                    <img src="{{ asset('boubacar.jpg') }}" class="rounded-circle mb-3" width="180" alt="Client">
