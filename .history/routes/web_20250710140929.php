...
Route::get('/admin/agents/{id}/modifier', [AdministrateurController::class, 'formulaireModifier'])->name('admin.agents.modifier');
Route::put('/admin/agents/{id}', [AdministrateurController::class, 'modifier'])->name('admin.agents.update');
Route::delete('/admin/agents/{id}', [AdministrateurController::class, 'supprimer'])->name('admin.agents.supprimer');
