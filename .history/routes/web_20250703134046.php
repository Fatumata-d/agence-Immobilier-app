...
Route::get('/connecterAdm', [AdministrateurController::class, 'formulaireConnexion'])->name('connexionAdmin');

Route::get('/connecterAgen', [AgentController::class, 'formulaireConnexion'])->name('connexionAgent');