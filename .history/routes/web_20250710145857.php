...
Route::get('/succés', function () {
    return view('validationAdminDashboard');
})->name('AdminDashboard');
...
Route::put('/agent/bien/{id}/mettre-a-jour', [AgentController::class, 'mettreAJour'])->name('BienMettreAJour');


Route::get('/admin/agents/{id}/modifier', [AdministrateurController::class, 'formulaireModifier'])->name('AgentsModifier');
Route::put('/admin/agents/{id}', [AdministrateurController::class, 'modifier'])->name('modifieragents');
Route::delete('/admin/agents/{id}', [AdministrateurController::class, 'supprimer'])->name('AgentsSupprimer');
