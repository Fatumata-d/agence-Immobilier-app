...
Route::get('/deconnexion-admin', [AdministrateurController::class, 'deconnexion'])->name('deconnexion');
...
Route::get('/deconnexion-agent', [AgentController::class, 'deconnexion'])->name('deconnexion');
