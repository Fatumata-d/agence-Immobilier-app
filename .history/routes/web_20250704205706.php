...
Route::get('/reserver/{bien}', [ReservationController::class, 'afficherFormulaire'])->name('reservation.formulaire');
Route::post('/reserver', [ReservationController::class, 'enregistrerReservation'])->name('reservation.enregistrer');
