...
Route::put('/agent/bien/{id}/statut', [App\Http\Controllers\AgentController::class, 'changerStatut'])->name('agent.bien.statut');

// Supprimer un bien (si tu veux gérer la suppression plus tard)
Route::delete('/agent/bien/{id}', [App\Http\Controllers\AgentController::class, 'supprimer'])->name('agent.bien.supprimer');

// Formulaire de modification d'un bien (optionnel pour l’étape suivante)
Route::get('/agent/bien/{id}/modifier', [App\Http\Controllers\AgentController::class, 'formulaireModifier'])->name('agent.bien.modifier');
