...
Route::post('/inscrire', [ClientAuthController::class, 'inscrire'])->name('inscriptionTraitement');



Route::get('/connecter', [ClientController::class, 'formulaireConnexion'])->name('connexion');
Route::post('/connecter', [ClientAuthController::class, 'connecter'])->name('inscriptionTraitement');
