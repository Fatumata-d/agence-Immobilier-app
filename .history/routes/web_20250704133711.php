...
Route::get('/formulaireRes', [ReservationController::class, 'formulaire'])->name('FormulaireReservation');


Route::get('/ajouterBien', [BienImmobilierController::class, 'formulaireAjout'])->name('ajouter')