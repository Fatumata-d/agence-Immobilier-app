...
class BienImmobilierController extends Controller
{
    ...
    public function enregistrer(Request $request)
    {
        ...
        return redirect()->route('dashboardAgent')->with('success', 'Bien ajouté avec succès.');
    }

    public function liste()
{
    $biens = BienImmobilier::with(['agent', 'type'])->get();
    return view('BienImmobilier', compact('biens'));
}
}
